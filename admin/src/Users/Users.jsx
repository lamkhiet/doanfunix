...
function Users(props) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await UserAPI.getPagination(newQuery);
                  ...
                  <table className="table table-striped table-hover text-nowrap align-middle mb-0">
                    <thead className="table-light">
                      <tr>
                        ...
                        <th className="py-3">Quyền Tài Khoản</th>
                      ...
                      {users &&
                        users.map((value) => (
                          <tr key={value._id}>
                            ...
                            <td className="py-3">
                              <span
                                className={`badge ${value.role === "Admin" ? "bg-primary" : "bg-secondary"} text-white`}
                              >
                                {value.role}
                              </span>
                            </td>
